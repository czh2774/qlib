    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if is_joinquant_ashare_limit_threshold(limit_threshold):
            ...
            self.trade_unit = (
                self._joinquant_ashare_policy.trade_unit
                if self.trade_unit is None
                else self.trade_unit
            )
        if deal_price is None:
            deal_price = (
                self._joinquant_ashare_policy.deal_price
                if self._joinquant_ashare_policy
                else C.deal_price
            )
